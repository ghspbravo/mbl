...
import { nameRegexp, emailRegexp } from "../../../constants/regexp";
	...
	return (
		<form onSubmit={handleSubmit(onSubmit)}>
			...
			<div className="mt-4">
				...
				{errors.roles && (
					<div className="error">{(errors.roles as any).message}</div>
				)}
			</div>
			...
			{errors.signUp && (
				<div className="error">{(errors.signUp as any).message}</div>
			)}

			<div className="mt-5">
				<button disabled={submitting} className="primary mx-auto">
