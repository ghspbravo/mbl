		...
		<div className="col-md-10 mx-auto">
			...
			<form className="no-gutters" onSubmit={handleSubmit(onSubmit)}>
              ...
              type="email"
				...
				{errors.auth && (
					<div className="error">{(errors.auth as any).message}</div>
				)}

				<div className="mt-3">
					<Link passHref href={Pages.Recover.route}>
						<a tabIndex={-1} className="primary">Забыли пароль?</a>
					</Link>
				</div>

				<div className="mt-5 col-10 col-sm-12 px-0 mx-auto">
					<button tabIndex={0} disabled={submitting} className="primary full">
