...
function Header({ router }): ReactElement {
	...
	const onSubmenuOpen = () => {
		profileSubmenuOpenSet(true);
	};
	const onSubmenuClose = () => {
		profileSubmenuOpenSet(false);
	};
	...
	const profileControls = (signedIn, user) => {
		...
		return signedIn ? (
			<div onClick={onSubmenuOpen} className="profile-controls">
				...
				{profileSubmenuOpen && (
					<Dropdown style={{ marginTop: "20px" }} closeHandler={onSubmenuClose}>
	...
	const citiesById: { [value: number]: string } = citiesList.reduce(
		(result, { value, name }) => ({
			...result,
			[value]: name,
		}),
				...
				<header>
						...
						<div className="container">
							<div className="row no-gutters align-items-center">
								<div style={{ position: "relative", zIndex: 6 }}>
									...
									<Select
										openCallback={onOpenCities}
										dropdownStyle={{ minWidth: "300px", maxHeight: "250px" }}
						...
						<div className="container">
							<div className="row no-gutters align-items-center navigation">
								...
								<div className="ml-auto d-xl-none">
									{!burgerMenuShow && (
										<div onClick={burgerMenuToggle} className="interactive">
								...
								{searchEnable && (
									<div className="search-input row no-gutters align-items-center justify-content-end">
							...
							{burgerMenuShow && (
								<div className="d-xl-none burger-inner">
									<div
										className="d-md-none"
									...
									>
										...
										<Select
											openCallback={onOpenCities}
											dropdownStyle={{ maxWidth: "300px", maxHeight: "250px" }}
											changeHandler={changeCityHandler}
											items={citiesList}
										>
											<span>
					...
					{burgerMenuShow && (
						<div
							...
							className="d-xl-none burger-menu-wrapper"
						/>
					)}
					...
					<style jsx global>{`
						body,
						html {
							overflow-y: ${burgerMenuShow ? "hidden" : "auto"};
						}
					`}</style>
