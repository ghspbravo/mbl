						...
						<div className="col-md-7">
							<div className="row">
								<div className="col-6 col-xl-3 col-md-4">
									<Link href={News.route} passHref>
										<a className="footer-nav-item">{News.title}</a>
									</Link>
								</div>
								<div className="col-6 col-xl-3 col-md-4">
									<Link href={Events.route} passHref>
										<a className="footer-nav-item">{Events.title}</a>
									</Link>
								</div>
								<div className="col-6 col-xl-3 col-md-4">
								...
								<div className="col-6 col-xl-3 col-md-4">
									<Link href={About.route} passHref prefetch={false}>
										<a className="footer-nav-item">
											<Badge small>В разработке</Badge>
											{About.title}
										</a>
								...
								<div className="col-6 col-xl-3 col-md-4">
									<Link href={Members.route} passHref>
										<a className="footer-nav-item">{Members.title}</a>
									</Link>
								</div>
								<div className="col-6 col-xl-3 col-md-4">
									<Link href={Companies.route} passHref>
										<a className="footer-nav-item">{Companies.title}</a>
									</Link>
								</div>
								<div className="col-6 col-xl-3 col-md-4">
									<Link href={Projects.route} passHref prefetch={false}>
