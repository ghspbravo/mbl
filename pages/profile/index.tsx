        ...
        <div className="container">
          ...
          <div className="row">
            <div className="d-none d-lg-block col-lg-4">
              <img className="responsive" src={pass} alt="Фотография человека" />
            ...
            <div className="col-lg-8">
              <h1>Петров Николай Алексеевич</h1>

              <div className="row no-gutters mb-5">
                <div className="mb-2"><Tag>Ментор</Tag></div>
              </div>

              <div className="d-lg-none mb-4">
                <img className="responsive mx-auto" style={{ maxWidth: "350px" }} src={pass} alt="Фотография человека" />
              </div>
